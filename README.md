...
## Train
1. To faster convergence, we first trained the 2D modules (Box, Keypoint) based on the pre-trainned COCO 2017 weights ([hear])(https://drive.google.com/file/d/1GZyzJLB3FTcs8C7MpZRQWw44liYPyOMD/edit).
4. Replace the third line of `configs/custom.yaml` - `best_rel_model.pth` to `CenterNet2_R2-101-DCN-BiFPN_4x+4x_1560_ST.pth`.
